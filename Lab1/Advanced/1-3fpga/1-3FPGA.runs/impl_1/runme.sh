...
HD_PWD='D:/GitHub/2023-Fall-Hardware_Design_and_Lab_Lee/Lab1/Advanced/1-3fpga/1-3FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Crossbar_2x2_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Crossbar_2x2_4bit.tcl -notrace
