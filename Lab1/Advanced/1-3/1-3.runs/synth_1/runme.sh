...
HD_PWD='D:/GitHub/2023-Fall-Hardware_Design_and_Lab_Lee/Lab1/Advanced/1-3/1-3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Crossbar_4x4_4bit_t.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Crossbar_4x4_4bit_t.tcl
