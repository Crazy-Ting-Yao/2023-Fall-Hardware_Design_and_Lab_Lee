...
set_property PACKAGE_PIN J2 [get_ports echo]
...
set_property PACKAGE_PIN B15 [get_ports left_signal]
    set_property IOSTANDARD LVCMOS33 [get_ports left_signal]
set_property PACKAGE_PIN B16 [get_ports mid_signal]
...
set_property PACKAGE_PIN K17 [get_ports left_motor]
    set_property IOSTANDARD LVCMOS33 [get_ports left_motor]
set_property PACKAGE_PIN M18 [get_ports {left[0]}]
...
set_property PACKAGE_PIN M19 [get_ports {right[0]}]
