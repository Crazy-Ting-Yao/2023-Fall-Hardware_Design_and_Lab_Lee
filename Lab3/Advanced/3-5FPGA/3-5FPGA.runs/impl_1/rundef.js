...
ISEStep( "vivado",
         "-log Parameterized_Ping_Pong_Counter_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Parameterized_Ping_Pong_Counter_FPGA.tcl -notrace" );
