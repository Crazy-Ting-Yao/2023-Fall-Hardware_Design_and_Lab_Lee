...
HD_PWD='D:/GitHub/2023-Fall-Hardware_Design_and_Lab_Lee/Lab2/Basic/2-1/2-1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NAND_Implement_t.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NAND_Implement_t.tcl
