...
HD_PWD='D:/GitHub/2023-Fall-Hardware_Design_and_Lab_Lee/Lab2/Advanced/2-2FPGA/2-2fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decode_And_Execute_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decode_And_Execute_FPGA.tcl
